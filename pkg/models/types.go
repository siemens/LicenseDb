...
type LicenseDB struct {
	...
	Url             string                                       `json:"rf_url" gorm:"column:rf_url;default:''" example:"https://opensource.org/licenses/MIT"`
	...
	Copyleft        bool                                         `json:"rf_copyleft" gorm:"column:rf_copyleft;default:false"`
	FSFfree         bool                                         `json:"rf_FSFfree" gorm:"column:rf_FSFfree;default:false"`
	OSIapproved     bool                                         `json:"rf_OSIapproved" gorm:"column:rf_OSIapproved;default:false"`
	GPLv2compatible bool                                         `json:"rf_GPLv2compatible" gorm:"column:rf_GPLv2compatible;default:false"`
	GPLv3compatible bool                                         `json:"rf_GPLv3compatible" gorm:"column:rf_GPLv3compatible;default:false"`
	Notes           string                                       `json:"rf_notes" gorm:"column:rf_notes;default:''" example:"This license has been superseded."`
	Fedora          string                                       `json:"rf_Fedora" gorm:"column:rf_Fedora;default:''"`
	TextUpdatable   bool                                         `json:"rf_text_updatable" gorm:"column:rf_text_updatable;default:false"`
	DetectorType    int64                                        `json:"rf_detector_type" gorm:"column:rf_detector_type;default:0" example:"1"`
	Active          bool                                         `json:"rf_active" gorm:"column:rf_active;default:true"`
	Source          string                                       `json:"rf_source" gorm:"column:rf_source;default:''"`
	SpdxId          string                                       `json:"rf_spdx_id" gorm:"column:rf_spdx_id" example:"MIT"`
	Risk            int64                                        `json:"rf_risk" gorm:"column:rf_risk"`
	Flag            int64                                        `json:"rf_flag" gorm:"default:1;column:rf_flag;default:0" example:"1"`
